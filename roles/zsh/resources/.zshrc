...
# GUI notification
alias notify="notify-send -u low -a "Terminal" -i /usr/share/icons/Paper/48x48@2x/apps/gnome-xterm.png 'Process finished'"

# vim related
alias vim="vim -p"

# fix screen resolution
alias fixsc="xrandr --output eDP1 -s 2880x1620"
